define(["text!module/bid/bidDetail.html", "text!module/header/bidHeader.html", "text!module/header/bidnavigation.html", "text!module/bid/comLoad.html", "text!module/bid/goods.html", "text!littleLogin.html", "module/bid/littleLogin", 'js/libs/jquery.validate.min', 'js/libs/additional.methods', "css!module/bid/style/bid.css?", "css!style/littleLogin.css?"], function(tpl, header, nav, comHtml, goodsHtml, littleLogin, load) {
	var controler = function() {
		...
		function getListCallbackFun(datas) {
			if(datas.resultCode === "0000") {
				...
				//放弃竞价
				$("#giveup-price").on("click", function() {
					...
					dialog({
						...
						content: "是否放弃竞价？",
						ok: function() {
							common.postData(giveUpUrl, g, priceCallback, true);
						},
						cancel: true,
					}).width(320).show();
