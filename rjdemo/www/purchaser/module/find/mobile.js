			...
			submitHandler: function() {
				var findPass = (function() {
					...
					var callbackGetFun = function(datas) {
						...
						if(datas.code == "0000") {
							clearTimeout(times);
							window.location.href = "#mobilesecond?account=" + encodeURIComponent(datas.account, "utf8") + "&token=" + encodeURIComponent(datas.token, "utf8");
					...
					var callbackSetFun = function(datas) {
						if(datas.code == "0000") {
							window.location.href = "#mobilethird";
					...
					return {
						findPassGetCode: function() {
							common.postData(baseUrl + urls.allUrls.getPasswordMobile, getCodeData, callbackGetFun, true);
						},
						setNewPassMethod: function() {
							common.postData(baseUrl + urls.allUrls.setNewPassword, setNewPassData, callbackSetFun, true);
						}
					};
				})();
