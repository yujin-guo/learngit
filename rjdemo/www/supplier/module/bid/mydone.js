define(['text!module/bid/mydone.html', 'text!module/bid/loadLlist.html', 'js/libs/laydate.dev', 'css!module/bid/style/bid.css?'], function(tpl, loadHtml) {
	var controller = function() {
		//菜单栏tab选中
		common.tabFocus("竞价中标");
		var commonFunUrl = function(params, callbackFun) {
			common.postData(common.bidBaseUrl + urls.allUrls.getDoneBidList, params, callbackFun, true);
		};
		var pageIndex = 1;
		var listData = {};
